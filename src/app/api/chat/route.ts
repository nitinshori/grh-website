...
- 70+ PGDs included across weight management (Wegovy, Mounjaro, Saxenda, Mysimba, Orlistat), travel (yellow fever, rabies, JE, MenACWY, dengue, anti-malarials, traveller's diarrhoea, altitude, typhoid), hormones (HRT, TRT, testosterone for women), sexual health (ED, PE, BPH, contraception, STI testing, PrEP, gonorrhoea, herpes, genital warts, BV, thrush), vaccines (flu, COVID, shingles, pneumococcal, HPV, MMR, chickenpox, MenB, RSV, hep B), skin (acne, rosacea, eczema, cold sores, impetigo, wound care, alopecia), respiratory (asthma, COPD), CVD (hypertension, statins), mental health (anxiety propranolol, sleep melatonin), smoking cessation, and more.
