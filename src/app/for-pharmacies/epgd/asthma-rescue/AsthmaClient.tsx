...
export default function AsthmaClient() {
        ...
        return (
          <div className="space-y-4">
            ...
            <div className="pt-2 border-t border-gray-200">
              <p className="text-sm font-medium text-navy-900 mb-2">Salbutamol cautions (PGD v008)</p>
            ...
            <div className="pt-2 border-t border-gray-200">
              <p className="text-sm font-medium text-navy-900 mb-2">Prednisolone exclusions (PGD v008)</p>
              <div className="space-y-2">
            ...
            <div className="pt-2 border-t border-gray-200">
              <p className="text-sm font-medium text-navy-900 mb-2">Prednisolone cautions (PGD v008)</p>
              <div className="space-y-2">
  ...
  // Advice given and decision reached for an excluded patient (PGD v008:
