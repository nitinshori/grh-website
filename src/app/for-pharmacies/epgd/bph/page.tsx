      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-500 mt-1">
            Tamsulosin 400mcg MR capsules for Benign Prostatic Hyperplasia PGD, version 005, issued 14 September 2026. Men aged 45 and over with an IPSS of 8 or more.
          </p>
        </div>
