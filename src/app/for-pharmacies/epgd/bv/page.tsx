    ...
    <div className="min-h-screen bg-gray-50 py-6 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600">Treatment of uncomplicated bacterial vaginosis in non-pregnant women (oral metronidazole 400 mg, 16 to 65; metronidazole 0.75% vaginal gel, 18 to 65). PGD version 005, issued 14 September 2026.</p>
        </div>
        <BVClient />
      </div>
    </div>
