...
interface CholeraSummaryReportProps {
  patientDetails: CholeraPatientDetails;
  consent: CholeraConsent;
  summary: CholeraSummary;
...
export default function CholeraSummaryReport({
  patientDetails,
  consent,
  summary,
  medicalHistory,
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
      ...
      <div className="px-6 py-5 border-b border-gray-100 bg-gray-50/50 print:bg-white print:border-0 print:pb-4">
        ...
        <p className="text-sm text-gray-500 mt-1">Cholera ePGD</p>
      </div>
      ...
      <div className="px-6 py-6 space-y-6 print:space-y-4">
        ...
        <div>
          ...
          <div className="space-y-1.5">
            ...
            <Row
              label="Previous Cholera dose"
              value={
                patientDetails.previousCholeraDose
        ...
        <div>
          ...
          <CounsellingGrid
            items={[
              ['Anaphylaxis to a previous cholera dose', medicalHistory.anaphylaxisPreviousDose],
              ['Hypersensitivity to formaldehyde / excipient', medicalHistory.hypersensitivityComponent],
              ['Acute gastrointestinal illness', medicalHistory.acuteGastroIllness],
        ...
        <div>
          ...
          <div className="space-y-1.5">
            <Row label="Vaccine" value={summary.vaccineType === 'dukoral' ? 'Dukoral (oral)' : summary.vaccineType === 'vaxchora' ? 'Vaxchora (oral)' : 'Not recorded'} />
        ...
        <div>
          ...
          <CounsellingGrid
            items={[
              ...
              ['Understands oral administration', consent.understandsOralAdministration],
              ['Understands dose schedule', consent.understandsCourseSchedule],
