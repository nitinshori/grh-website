          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 sm:p-8">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-900">
                This ePGD guides pharmacists through safe and effective administration of Qdenga (TAK-003) dengue vaccination for patients travelling to dengue endemic areas. Suitable for patients aged 4 years and over, with careful assessment of contraindications and travel risk.
              </p>
            </div>
          </div>
        </div>
