...
// Aligned to the signed PGD version 009, issued 14 September 2026:
...
export const PGD_STRAPLINE = "Acute Dental Infection (bridging antibiotic) PGD version 009, issued 14 September 2026";
...
export default function DentalBridgingClient() {
  ...
  const clinicalAlerts = useMemo<ClinicalAlert[]>(() => {
    ...
    // Metronidazole arm exclusions. These are exclusions in v009, not
  ...
  // Required records before leaving the assessment (PGD v009 inclusion
