...
export const metadata: Metadata = { title: "Acute Dental Infection Bridging Antibiotic ePGD", description: "Digital consultation tool for the supply of a bridging antibiotic in acute dental infection under Patient Group Direction (version 009, 14 September 2026)." };
    ...
    <div className="bg-gray-50 min-h-screen">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-600 mt-1">Amoxicillin or metronidazole, adults 18 and over, spreading or systemic dental infection only. PGD version 009, issued 14 September 2026.</p>
        </div>
