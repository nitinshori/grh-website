...
export const metadata: Metadata = { title: "Acute Otitis Externa ePGD Consultation", description: "Digital consultation tool for acute otitis externa: ciprofloxacin 2mg/ml ear drops or dexamethasone, neomycin and acetic acid ear spray under Patient Group Direction (version 007, 14 September 2026)." };
    ...
    <div className="bg-gray-50 min-h-screen">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-500 mt-1">Ciprofloxacin 2mg/ml single-dose ear drops, or dexamethasone with neomycin and acetic acid ear spray. Otitis externa only; otoscopy required. PGD version 007, issued 14 September 2026.</p>
        </div>
        <EarInfectionClient />
