    ...
    return (
      <div className="space-y-4">
        ...
        <div className="mb-4 rounded-lg border border-amber-300 bg-amber-50 px-3 py-3 space-y-3">
            <div>
              <p className="text-sm font-semibold text-amber-900">Cardiovascular fitness (PGD v009, Appendix 1). Complete for every patient, at every supply, and record the answers.</p>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-1">
          ...
          <Checkbox
            ...
            description="EXCLUSION under PGD v009"
          />
          <Checkbox
    ...
    return (
      <div className="space-y-4">
        ...
        <Checkbox
          ...
          description="EXCLUSION in both arms of PGD v009."
        />
      </div>
    );
  }
    ...
    return (
      <div className="space-y-4">
        ...
        <Checkbox
          ...
          description="EXCLUSION under PGD v009. Refer for a diagnosis rather than treating the symptom."
        />
        <Checkbox
