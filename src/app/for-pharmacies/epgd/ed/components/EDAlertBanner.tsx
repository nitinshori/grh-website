...
import type { ClinicalAlert, AlertSeverity } from "../lib/ed-types";

interface EDAlertBannerProps {
...
export function EDAlertBanner({ alerts }: EDAlertBannerProps) {
  if (alerts.length === 0) return null;

  // Sort by severity: stop first, then caution, then red-flag
