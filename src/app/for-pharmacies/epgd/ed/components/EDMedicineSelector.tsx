...
interface EDMedicineSelectorProps {
  ...
  /** PGD v009 arm exclusions (ritonavir/cobicistat bars sildenafil; doxazosin bars tadalafil). */
  armAvailability?: ArmAvailability;
  /** PGD v009 dose caps and starting-dose rules. */
  caps?: DoseCaps;
}
      ...
      <div>
        ...
        {caps && caps.reasons.length > 0 && (
          <div className="mb-3 rounded-lg border border-amber-300 bg-amber-50 px-3 py-2 text-xs text-amber-900">
            <p className="font-semibold">Dose limits for this patient (PGD v009):</p>
