    ...
    <div className="max-w-3xl mx-auto print:max-w-none">
      ...
      <dl>
        ...
        <Row
          ...
          value={
            state.medicalHistory.hepaticImpairment === "none"
              ? "None"
              : state.medicalHistory.hepaticImpairment === "mild-moderate"
                ? "Mild to moderate (Child-Pugh A or B)"
                : state.medicalHistory.hepaticImpairment === "severe"
                  ? "Severe (Child-Pugh C)"
                  : "Not asked"
          }
        />
        <Row
          ...
          value={
            state.medicalHistory.renalImpairment === "none"
              ? "None"
              : state.medicalHistory.renalImpairment === "moderate"
                ? "Moderate (creatinine clearance 30 to 50 mL/min)"
                : state.medicalHistory.renalImpairment === "severe"
                  ? "Severe (creatinine clearance below 30 mL/min)"
                  : "Not asked"
          }
        />
        <Row
      ...
      <dl>
        ...
        />
        <Row
          label="Poppers (amyl or alkyl nitrite): direct question"
          value={
            !state.medications.poppersQuestionAsked
              ? "Not asked"
              : state.medications.usesPoppers
                ? "Asked: YES, uses or might use (excluded)"
                : "Asked: No, does not use"
          }
        />
        <Row
        ...
        <Row
          ...
          value={
            state.medications.takesAlphaBlockers
              ? `Yes: ${state.medications.alphaBlockerDetails || "not specified"}; stable: ${!state.medications.alphaBlockerStabilityAnswered ? "not asked" : state.medications.alphaBlockerStable ? "yes" : "no"}${state.medications.takesDoxazosin ? "; doxazosin (tadalafil excluded)" : ""}`
              : "No"
          }
        />
        <Row
        ...
        <Row
          label="Allergies"
          value={state.medications.allergies.trim() || "Not recorded"}
        />
        <Row
      ...
      <dl>
        ...
        />
        <Row
          label="Chest pain, breathlessness or palpitations on exertion or during sex"
          value={
