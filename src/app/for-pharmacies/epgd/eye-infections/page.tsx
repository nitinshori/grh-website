...
export const metadata: Metadata = { title: "Eye Infections, Chloramphenicol Consultation ePGD", description: "Digital consultation tool for bacterial conjunctivitis: chloramphenicol 0.5% eye drops and 1% eye ointment under the Get Real Health PGD, version 004, issued 14 September 2026." };
    ...
    <div className="bg-gray-50 min-h-screen">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="mb-6 print:hidden">
          ...
          <p className="text-sm text-gray-500 mt-1">Bacterial conjunctivitis in adults and children aged 2 years and over: chloramphenicol 0.5% eye drops and 1% eye ointment. PGD version 004, issued 14 September 2026.</p>
        </div>
        <EyeInfectionsClient />
