    ...
    <div className="space-y-8">
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        ...
        <p className="text-xs text-gray-500 mb-6">
          Administered via the Patient Group Direction for seasonal influenza vaccines (IIVc, aIIV, IIVr and IIVe), version 006, issued 14 September 2026.
        </p>
        ...
        <section className="mb-8 pb-8 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-700 mb-4">
            {hasStop
              ? `I confirm that this consultation was conducted in accordance with the Patient Group Direction for seasonal influenza vaccines (${FLU_SEASON}), version 006, that an exclusion criterion applied, that no vaccine was administered, and that the patient was advised as recorded above.`
              : `I confirm that this vaccine was administered in accordance with the Patient Group Direction for seasonal influenza vaccines (${FLU_SEASON}), version 006, that the patient met the inclusion criteria and that no exclusion criterion applied.`}
          </p>
