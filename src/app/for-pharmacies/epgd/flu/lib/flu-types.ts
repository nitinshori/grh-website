...
/** Vaccine types covered by PGD v006. */
...
/** PGD v006 consent block: under 16, who consented. */
...
export interface FluVaccineAdministration {
  ...
  /** Brand name as on the pack (PGD v006 records row: name and brand, and the vaccine type). */
  brandName: string;
  batchNumber: string;
  expiryDate: string;
  ...
  nextDoseDue: string;
  /** Adrenaline 1 in 1,000 and a telephone immediately available (PGD v006 caution). */
