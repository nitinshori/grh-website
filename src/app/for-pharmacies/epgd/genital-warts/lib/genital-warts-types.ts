 ...
 *
 * Aligned to the signed PGD version 006, issued 14 September 2026 (valid
...
export const PGD_VERSION_LINE =
  "Genital Warts PGD (podophyllotoxin and imiquimod), version 006, issued 14 September 2026";
