...
export const metadata: Metadata = {
  title: "Genital Warts Assessment & Treatment ePGD",
  description: "Genital Warts Assessment & Treatment ePGD consultation tool - Coming Soon. Clinical assessment of external genital and perianal warts under PGD.",
};
    ...
    <div className="bg-gray-50 min-h-screen">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-navy-900">Genital Warts Assessment & Treatment</h1>
          <p className="text-sm text-gray-600 mt-1">Podophyllotoxin supply under PGD</p>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
          <p className="text-gray-700 text-sm">
            This ePGD consultation tool is currently in development. We're working to bring you a structured digital consultation experience for genital warts assessment and podophyllotoxin supply.
          </p>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-[11px] text-gray-400 max-w-2xl mx-auto">This ePGD is for external anogenital warts only. Internal, cervical, or anal warts require specialist referral.</p>
        </div>
      </div>
    </div>
  );
