...
export const metadata: Metadata = {
  ...
  description: "Gonorrhoea Treatment Consultation ePGD - Coming Soon. Ceftriaxone 1 g IM (reconstituted with lidocaine 1%) under PGD version 005, issued 14 September 2026, for adults with a positive NAAT or strong clinical suspicion with a clear epidemiological link.",
};
    ...
    <div className="bg-gray-50 min-h-screen">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-600 mt-1">Ceftriaxone 1 g IM, reconstituted with 3.5 mL lidocaine 1%, under PGD version 005, issued 14 September 2026</p>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-[11px] text-gray-400 max-w-2xl mx-auto">This ePGD requires a positive NAAT for N. gonorrhoeae or strong clinical suspicion with a clear epidemiological link. Partner notification and test of cure at 2 weeks are essential components. PGD version 005, issued 14 September 2026.</p>
        </div>
      </div>
    </div>
  );
