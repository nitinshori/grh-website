      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="mb-6 print:hidden">
          ...
          <p className="text-sm text-gray-500 mt-1">
            Finasteride 1 mg tablets for androgenetic alopecia (male pattern hair loss) in men aged 18 to 65 years. PGD version 004, issued 14 September 2026.
          </p>
        </div>
        ...
        <div className="mt-8 text-center print:hidden">
          <p className="text-[11px] text-gray-400 max-w-2xl mx-auto">
            ...
            guidance and the Get Real Health PGD for Finasteride (Androgenetic Alopecia), version 004, 14 September 2026.
          </p>
        </div>
      </div>
    </div>
