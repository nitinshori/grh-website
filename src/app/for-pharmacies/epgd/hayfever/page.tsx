      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-500 mt-1">
            ...
            PGD version 006, issued 14 September 2026.
          </p>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-[11px] text-gray-400 max-w-2xl mx-auto">
            ...
            guidance and the Get Real Health PGD for Fexofenadine and/or Dymista (Allergic Rhinitis), version 006, 14 September 2026.
          </p>
        </div>
      </div>
    </div>
