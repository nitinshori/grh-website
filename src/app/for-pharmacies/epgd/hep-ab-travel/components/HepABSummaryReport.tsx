...
interface HepABSummaryReportProps {
  patientDetails: HepABPatientDetails;
  consent: HepABConsent;
  summary: HepABSummary;
  medicalHistory: {
...
export default function HepABSummaryReport({
  patientDetails,
  consent,
  summary,
  medicalHistory,
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
      ...
      <div className="px-6 py-5 border-b border-gray-100 bg-gray-50/50 print:bg-white print:border-0 print:pb-4">
        ...
        <p className="text-sm text-gray-500 mt-1">Hepatitis A/B Travel ePGD</p>
      </div>
      ...
      <div className="px-6 py-6 space-y-6 print:space-y-4">
        ...
        <div>
          ...
          <div className="space-y-1.5">
            ...
            <Row
              label="Previous HepAB dose"
              value={
                patientDetails.previousHepABDose
        ...
        <div>
          ...
          <CounsellingGrid
            items={[
              ['Anaphylaxis to previous HepAB', medicalHistory.anaphylaxisToVaccine],
        ...
        <PharmacistDeclaration
          pgdName="Hepatitis A/B Travel"
          pharmacistName={summary.pharmacistName}
          pharmacistGPhC={summary.pharmacistGPhC}
          pharmacyName={summary.pharmacyName}
        />

        <ReportFooter pgdName="Hepatitis A/B Travel" />
      </div>
