...
export function validateHepABPatientStep(
...
export function validateHepABTravelStep(
  patient: HepABPatientDetails,
  travelAssessment: {
...
export function validateHepABConsentStep(
  consent: HepABConsent
): string | null {
...
export function validateHepABMedicalHistoryStep(data: {
...
export function validateHepABContraindicationsStep(data: {
...
export function validateHepABAdministrationStep(
  summary: Partial<HepABSummary>
): string | null {
...
export function validateHepABPostVaccineStep(data: {
...
export function validateHepABSummaryStep(
  summary: Partial<HepABSummary>
): string | null {
