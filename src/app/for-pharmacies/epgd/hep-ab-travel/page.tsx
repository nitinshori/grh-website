...
export const metadata = {
  ...
  description:
    'UK Pharmacy Patient Group Direction (PGD) consultation tool for hepatitis A and hepatitis B vaccination in travel and lifestyle-risk situations. Twinrix, Havrix, Avaxim and Engerix B with standard, accelerated and very rapid schedules. PGD v009, 14 September 2026.',
};
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 sm:p-8">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-900">
                ...
                Hepatitis A and Hepatitis B Vaccination PGD v009, issued
                14 September 2026. Supports the standard (0, 1 and 6 months),
