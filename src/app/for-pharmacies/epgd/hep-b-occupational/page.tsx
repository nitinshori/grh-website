...
import HepBOccupationalClient from "./HepBOccupationalClient";
import { PgdPageActions } from "@/components/PgdPageActions";
export const metadata: Metadata = { title: "Hepatitis B Occupational Vaccine Consultation ePGD", description: "Digital consultation tool for Hepatitis B Occupational Vaccine under Patient Group Direction." };
    ...
    <div className="bg-gray-50 min-h-screen">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-500 mt-1">Engerix B 20 micrograms/1 mL or HBvaxPRO 10 micrograms/1 mL, individuals aged 16 years and over at occupational, travel or lifestyle risk. Hepatitis B (Engerix B / HBvaxPRO) PGD v006, issued 14 September 2026.</p>
        </div>
