      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-600 mt-1">
            ...
            Genital Herpes Management PGD, version 006, issued 14 September 2026.
          </p>
        </div>
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-6">
          ...
          <p className="text-amber-900 text-sm">
            Please refer to the signed Genital Herpes Management PGD (version 006, issued 14 September 2026) for clinical guidance and supply under it on paper.
          </p>
        </div>

        {/* Disclaimer */}
        <div className="mt-8 text-center">
          <p className="text-[11px] text-gray-400 max-w-2xl mx-auto">No electronic consultation tool exists yet for this PGD. Any supply of aciclovir or valaciclovir for genital herpes must be made on paper under the signed Genital Herpes Management PGD (version 006).</p>
        </div>
      </div>
    </div>
  );
