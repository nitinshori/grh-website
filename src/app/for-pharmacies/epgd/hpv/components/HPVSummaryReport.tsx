  ...
  return (
    <div className="max-w-4xl mx-auto bg-white p-6 rounded-lg border border-gray-200 print:border-0 print:shadow-none print:p-0">
      ...
      <div className="border-b border-gray-300 pb-4 mb-6">
        ...
        <p className="text-xs text-gray-500 mt-1">
          Administered under the Get Real Health Gardasil 9 PGD, version 007, issued 14 September 2026.
        </p>
      </div>
      ...
      <div className="space-y-0.5">
        ...
        <Row label="Immunosuppressed or HIV positive" value={state.assessment.immuneStatusAnswer === "yes" ? "Yes: three-dose schedule" : state.assessment.immuneStatusAnswer === "no" ? "No" : "Not recorded"} />
