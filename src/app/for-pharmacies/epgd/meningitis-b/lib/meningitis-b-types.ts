...
/**
 * Indication and exclusion questions. PGD v007: the indications are missed
...
export const MENB_PGD_VERSION =
  "Meningococcal group B vaccine (Bexsero and Trumenba) PGD v007, issued 14 September 2026";
