// ─── MMR Clinical Logic ───
// Aligned to the MMRVaxPRO / Priorix PGD version 006, issued 14 September 2026.
...
export function getAllAlerts(state: MMRConsultationState): ClinicalAlert[] {
  ...
  // Age: indicated from 12 months of age (PGD v006 inclusion)
  ...
  // Haematological / lymphatic malignancy (PGD v006 exclusion)
  ...
  // Family history of immunodeficiency (PGD v006 exclusion)
  ...
  // Yellow fever or varicella vaccine in the previous 4 weeks (PGD v006 exclusion: defer)
  ...
  // Hypersensitivity to any other component (PGD v006 exclusion)
  ...
  // Anaphylaxis to a previous MMR-containing vaccine (PGD v006 exclusion)
  ...
  // Acute febrile illness (PGD v006 exclusion: postpone)
  ...
  // Blood products or immunoglobulin in the previous 3 months (PGD v006 caution)
  if (state.medicalHistory.recentBloodProducts && state.medicalHistory.bloodProductsAction !== "deferred") {
    const which =
  ...
  // Thrombocytopenia or febrile seizures (PGD v006 caution)
