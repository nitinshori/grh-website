...
export function validateStep(step: number, state: MounjaroConsultationState): string | null {
  switch (step) {
    case 0: { // Patient Details (PGD v010: adults aged 18 to 75 years inclusive)
    ...
    case 7: { // Counselling (PGD v010 cautions, follow-up advice and written information rows)
