      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-500 mt-1">
            Mounjaro (tirzepatide) Injection for weight management PGD, version 010, issued 14 September 2026. Adults aged 18 to 75 years. One KwikPen (4 weekly doses) per appointment.
          </p>
        </div>
        <MounjaroClient />
      </div>
