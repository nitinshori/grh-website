    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 sm:p-8">
            ...
            <p className="text-xs text-gray-500 mb-4">
              Patient Group Direction version 006, issued 14 September 2026. Valid from
              14 September 2026, expiry 31 July 2027.
            </p>
        ...
        <div className="mt-8 text-center text-xs text-gray-500">
          <p>Get Real Health ePGD, Mysimba (Naltrexone/Bupropion) PGD v006, 14 September 2026 | Confidential Patient Information</p>
        </div>
      </div>
    </div>
  )
