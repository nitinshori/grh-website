      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-500 mt-2">
            This ePGD guides pharmacists through supply of Orlistat 120mg capsules under the Patient Group Direction (version 005, issued 14 September 2026) as an adjunct to a reduced-calorie diet and lifestyle changes for adults aged 18 years and over and under 75 years with BMI 30 kg/m² or more, or BMI 28 kg/m² or more with an obesity-related comorbidity. Up to 84 capsules (28-day supply); review at 12 weeks.
          </p>
        </div>
        <OrlistatClient />
      </div>
