...
export const metadata = {
  ...
  description: "Patient Group Direction for primary dysmenorrhoea, naproxen or mefenamic acid, version 006, issued 14 September 2026",
};
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        <div className="mt-4">
          ...
          <p className="text-gray-600">Naproxen or Mefenamic acid for Period Pain (Dysmenorrhoea) PGD, version 006, issued 14 September 2026. Females aged 16 years and older; one cycle per supply.</p>
        </div>
      </div>
      <PeriodPainClient />
    </div>
