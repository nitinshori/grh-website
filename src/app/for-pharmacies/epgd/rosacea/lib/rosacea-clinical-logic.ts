...
export const PRODUCT_DETAILS: Record<string, { label: string; strength: string; frequency: string; duration: string; quantity: string; maxSupplies: number; notes: string[] }> = {
  metronidazole: {
