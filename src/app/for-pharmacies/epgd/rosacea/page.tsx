...
export const metadata: Metadata = { title: "Rosacea Treatment Consultation ePGD", description: "Digital consultation tool for rosacea assessment and treatment with metronidazole 0.75% gel or azelaic acid 15% gel under the Get Real Health PGD, version 005, issued 14 September 2026." };
    ...
    <div className="bg-gray-50 min-h-screen">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="mb-6 print:hidden">
          ...
          <p className="text-sm text-gray-500 mt-1">Assessment and treatment of mild to moderate rosacea in adults with metronidazole 0.75% gel or azelaic acid 15% gel. PGD version 005, issued 14 September 2026.</p>
        </div>
        <RosaceaClient />
