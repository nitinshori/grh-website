  ...
  return (
    <>
      ...
      {currentStep === 3 && (
        <>
          <div className="space-y-4">
            <p className="text-xs font-semibold text-gray-700 uppercase tracking-wide">Exclusion criteria (PGD v007)</p>
            ...
            <p className="text-xs font-semibold text-gray-700 uppercase tracking-wide pt-2">Cautions (PGD v007)</p>
      ...
      {currentStep === 6 && (
        <>
          <div className="space-y-4">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm font-semibold text-blue-900">Possible side effects to advise the patient about (PGD v007):</p>
              <ul className="text-xs text-blue-800 mt-2 space-y-1 list-disc list-inside">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
              <p className="text-sm font-semibold text-amber-900">Follow-up advice (PGD v007):</p>
