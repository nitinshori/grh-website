  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
      ...
      <div className="px-6 py-5 border-b border-gray-100 bg-gray-50/50 print:bg-white print:border-0 print:pb-4">
        ...
        <p className="text-sm text-gray-500 mt-1">RSV Vaccination ePGD (Abrysvo or Arexvy PGD v007)</p>
      </div>
      ...
      <div className="px-6 py-6 space-y-6 print:space-y-4">
        ...
        <div>
          ...
          <CounsellingGrid
            items={[
              ...
              ['Follow-up advice given (PGD v007 list)', !!postVaccineAdvice.followUpAdviceGiven] as [string, boolean],
        ...
        <p className="text-[10px] text-gray-500">
          Patient Group Direction for Abrysvo or Arexvy (RSV), version 007, issued 14 September 2026.
        </p>
