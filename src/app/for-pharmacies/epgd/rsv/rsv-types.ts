...
// Aligned to the Abrysvo / Arexvy RSV PGD version 007, issued 14 September 2026.
...
export interface RSVConsent extends BaseConsent {
  ...
  /** PGD v007 consent block, under 16 only: who gave consent. */
...
/** PGD v007 medical history and exclusion flags. */
...
/** Post-vaccination counselling, observation and adverse reaction record (PGD v007 cautions and records rows). */
