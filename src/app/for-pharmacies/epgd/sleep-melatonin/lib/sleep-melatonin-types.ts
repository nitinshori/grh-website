...
export interface SleepMelatoninAssessment {
  ...
  // PGD v009: poor quality of sleep of at least 4 weeks' duration. Under 4
...
/**
 * Secondary-cause history required by PGD v009. Each item must be asked and
...
export interface SleepMelatoninCounselling {
  ...
  // PGD v009 counselling and required records
