      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-500 mt-1">
            Circadin 2mg prolonged-release melatonin tablets, as monotherapy for the short-term treatment of primary insomnia in adults aged 55 and over. PGD version 008, issued 11 September 2026.
          </p>
        </div>
