      ...
      <div className="bg-white p-8 rounded-lg border border-gray-300">
        ...
        <div className="border-b-2 border-gray-300 pb-6 mb-6">
          <h1 className="text-3xl font-bold text-gray-900">
            Varenicline 0.5mg and 1mg tablets PGD Consultation Record (version 005, 14 September 2026)
          </h1>
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-gray-700 mb-4">
            {notSupplied
              ? "I confirm that this consultation was conducted under the Patient Group Direction for Varenicline (version 005, 14 September 2026), that an exclusion criterion applied, that varenicline was NOT supplied, and that the patient was advised on alternatives and referred as recorded."
              : "I confirm that this consultation was conducted in accordance with the Patient Group Direction for Varenicline (version 005, 14 September 2026), that the patient met all inclusion criteria and no exclusion criteria applied, and that the medicine was supplied under this PGD."}
          </p>
          <div className="grid grid-cols-2 gap-6">
            <div>
              <p className="text-xs font-semibold text-gray-500 uppercase">
