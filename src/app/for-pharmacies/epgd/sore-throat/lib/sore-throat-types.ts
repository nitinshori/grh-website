...
export interface SoreThroatSymptoms {
  ...
  // PGD v006 red flags (airway compromise, quinsy or epiglottitis): any one excludes
  stridor: boolean;
  difficultyBreathing: boolean;
  unableToSwallowSaliva: boolean;
  uvulaDeviation: boolean;
  // PGD v006: possible malignancy pathway, refer to GP
...
export interface SoreThroatExamination {
  ...
  // PGD v006 sepsis screen: temperature 38 or above together with any of these
