    ...
    return (
      <div className="space-y-4">
        <div className="flex gap-2 justify-between">
          <button onClick={handlePrev} className="px-4 py-2 text-sm font-medium text-navy-900 bg-gray-100 hover:bg-gray-200 rounded-lg">← Back</button>
          <button onClick={handlePrint} className="px-4 py-2 text-sm font-medium text-white bg-teal-600 hover:bg-teal-700 rounded-lg">Print Record</button>
        </div>
