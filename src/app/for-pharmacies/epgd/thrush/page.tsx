    ...
    <div className="min-h-screen bg-gray-50 py-6 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600">Uncomplicated vulvovaginal candidiasis in non-pregnant women aged 16 to 60: fluconazole 150 mg capsule or clotrimazole 500 mg pessary. PGD version 005, issued 11 September 2026.</p>
        </div>
        <ThrushClient />
      </div>
    </div>
