...
interface TBESummaryReportProps {
  patientDetails: TBEPatientDetails;
  consent: TBEConsent;
  summary: TBESummary;
...
export default function TBESummaryReport({
  patientDetails,
  consent,
  summary,
  medicalHistory,
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
      ...
      <div className="px-6 py-5 border-b border-gray-100 bg-gray-50/50 print:bg-white print:border-0 print:pb-4">
        ...
        <p className="text-sm text-gray-500 mt-1">TBE ePGD</p>
      </div>
      ...
      <div className="px-6 py-6 space-y-6 print:space-y-4">
        ...
        <div>
          ...
          <div className="space-y-1.5">
            ...
            <Row
              label="Previous TBE dose"
              value={
                patientDetails.previousTBEDose
        ...
        <div>
          ...
          <CounsellingGrid
            items={[
              ['Anaphylaxis to a previous TBE dose', medicalHistory.anaphylaxisPreviousDose],
              ['Hypersensitivity to egg / vaccine component', medicalHistory.hypersensitivityEggOrComponent],
              ['Acute febrile illness', medicalHistory.acuteFebrileIllness],
              ['Bleeding disorder / anticoagulant', medicalHistory.bleedingDisorder],
        ...
        <div>
          ...
          <div className="space-y-1.5">
            <Row label="Vaccine" value={summary.vaccineType === 'ticovac' ? 'TicoVac' : summary.vaccineType === 'ticovac-junior' ? 'TicoVac Junior' : 'Not recorded'} />
            <Row label="Dose number" value={summary.doseNumber ? `Dose ${summary.doseNumber}` : 'Not recorded'} />
            <Row label="Route" value="Intramuscular" />
            <Row label="Administration site" value={summary.administrationSite === 'left-deltoid' ? 'Left deltoid' : summary.administrationSite === 'right-deltoid' ? 'Right deltoid' : 'Not recorded'} />
        ...
        <div>
          ...
          <CounsellingGrid
            items={[
              ...
              ['Understands 3-dose schedule', consent.understandsCourseSchedule],
              ['Understands intramuscular injection', consent.understandsInjection],
              ['Understands timing before travel', consent.understandsTimingBeforeTravel],
              ['Advised of common reactions', postVaccineAdvice.counselledReactions],
              ['Understands must complete course', postVaccineAdvice.counselledValidity],
