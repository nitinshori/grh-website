...
// Aligned to the Azithromycin for Traveller's Diarrhoea PGD, version 006,
// issued 14 September 2026. The PGD supplies azithromycin only.
...
export const TD_PGD_VERSION = "Azithromycin for Traveller's Diarrhoea PGD v006, issued 14 September 2026";
...
export function generateTDAlerts(
  ...
  if (medical.feverAtOrAbove38C) {
    alerts.push({
      severity: 'stop',
      code: 'HIGH_FEVER',
      message: 'High fever (temperature 38 C or above): exclusion, refer for medical assessment',
      detail:
        'High fever, defined in the PGD as a temperature of 38 C or above, is an exclusion and suggests systemic infection. Refer to a doctor. Do not supply standby antibiotics.',
    });
  }
...
export function recommendApproach(
  ...
  // Check if any hard stops exist (PGD v006 exclusion criteria)
  if (
    medical.bloodInStool ||
    medical.feverAtOrAbove38C ||
