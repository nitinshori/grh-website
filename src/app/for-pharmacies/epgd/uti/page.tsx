      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600">
            Patient Group Direction: Urinary Tract Infection in Women aged 16 to 64, version 007, issued 11 September 2026. Nitrofurantoin first line; trimethoprim only where nitrofurantoin is unsuitable.
          </p>
        </div>
