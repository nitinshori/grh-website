...
export const metadata: Metadata = { title: "Minor Wound Care Consultation ePGD", description: "Minor Wound Care PGD v009: co-amoxiclav for infected bites and heavily contaminated wounds (12 and over), flucloxacillin for infected non-bite wounds (2 and over)." };
