 ...
 *
 * Aligned to PGD v006 (14 September 2026): pregnancy is an exclusion, any
  ...
  const validationError = useMemo(() => {
    switch (step) {
      case 0: {
        ...
        // PGD v006 records: name, address, date of birth and GP with whom the individual is registered.
