...
export const metadata = {
  ...
  description:
    'UK Pharmacy Group Protocol Direction (PGD) consultation tool for yellow fever vaccination in travel situations',
};
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 sm:p-8">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-900">
                This ePGD guides pharmacists in the supply and administration of Yellow Fever conjugate vaccines to eligible patients, particularly those travelling to high-risk regions or attending university.
              </p>
            </div>
          </div>
        </div>
