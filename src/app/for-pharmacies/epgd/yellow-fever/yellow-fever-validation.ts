...
export function validateYellowFeverPatientStep(
...
export function validateYellowFeverStep(
  patient: YellowFeverPatientDetails,
  travelAssessment: {
...
export function validateYellowFeverConsentStep(
...
export function validateYellowFeverMedicalHistoryStep(data: {
...
export function validateYellowFeverContraindicationsStep(data: {
...
export function validateYellowFeverAdministrationStep(
  summary: Partial<YellowFeverSummary>
): string | null {
...
export function validateYellowFeverPostVaccineStep(data: {
...
export function validateYellowFeverSummaryStep(
  summary: Partial<YellowFeverSummary>
): string | null {
