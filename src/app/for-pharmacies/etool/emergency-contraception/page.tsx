...
export const metadata: Metadata = {
  title: "Emergency Contraception Consultation eTool",
  description:
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-2 text-xs text-gray-500 mb-2">
            ...
            <span className="text-navy-900 font-medium">
              Emergency Contraception Consultation eTool
            </span>
          </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-[11px] text-gray-400 max-w-2xl mx-auto">
            This eTool is provided as a clinical decision support aid and does
