      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="bg-white rounded-lg shadow p-6 mb-6">
            <h1 className="text-4xl font-bold text-blue-900 mb-2">Impetigo eTool</h1>
        ...
        <div className="mt-8 text-center text-sm text-gray-600">
          <p>
            This eTool is designed to support pharmacists operating under a Patient Group Direction (PGD) for impetigo
            treatment.
          </p>
          <p className="mt-2">
