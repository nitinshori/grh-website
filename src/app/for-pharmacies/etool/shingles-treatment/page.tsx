  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Shingles Acute Treatment eTool</h1>
        ...
        <div className="mt-8 text-center text-sm text-gray-600">
          <p>
            This eTool supports PGD-based supply of antivirals for acute shingles management.
          </p>
          <p className="mt-2">
