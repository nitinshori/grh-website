    ...
    >
      <div className="space-y-6">
        ...
        <div className="bg-gray-100 border-2 border-gray-400 rounded-lg p-6 print:bg-white print:border-none print:p-0">
          ...
          <div className="bg-white p-8 print:p-0">
            ...
            <div className="border-b-2 border-gray-300 pb-4 mb-6">
              <h1 className="text-2xl font-bold text-gray-900">Shingles Acute Treatment eTool</h1>
        ...
        <div className="text-xs text-gray-600 text-center py-4 print:hidden">
          <p>This eTool supports PGD-based supply of antivirals for acute shingles management in UK pharmacies.</p>
