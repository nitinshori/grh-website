...
export const metadata: Metadata = {
  title: "UTI Consultation eTool | PGD Consultation",
  description:
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="mb-6 text-sm text-gray-600">
          ...
          {" > "}
          <a href="/for-pharmacies/etool" className="text-teal-600 hover:underline">
            eTool Consultations
          </a>
          {" > "}
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-lg px-6 py-4 mb-8">
          <p className="text-sm text-amber-900">
            <span className="font-semibold">Important:</span> This eTool is designed to support pharmacist-led consultations under the PGD for uncomplicated UTI in women aged 16-64. It provides clinical guidance and alerts but does not replace professional clinical judgment. All consultations must be conducted by an accredited pharmacist with appropriate training and supervision.
          </p>
        </div>
