...
export const pgds: PGD[] = [
  ...
  {
    id: "travel-specialist",
    title: "Japanese Encephalitis, Rabies, Meningitis ACWY",
    category: "Travel",
    priority: 1,
    isNew: false,
    revenueEstimate: "\u00a3100\u2013400 per course",
    consultTime: "20\u201330 min",
    description:
      "Completes a full travel clinic offering. High pharmacist confidence. Specialist vaccines for specific destinations.",
    pharmadoctor: "Yes",
  },
  {
