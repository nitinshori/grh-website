...
//   - contact_submit    : fires on /contact after a successful enquiry
//                         (payload.enquiry_type = demo | pricing | ...)
//
...
type DataLayerEvent = "book_demo_submit" | "onboard_complete" | "contact_submit";
