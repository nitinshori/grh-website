...
const STATIC_RESOURCES: StaticResourceInput[] = [
  ...
  {
    id: 'pph-wegovy-tablets-v006',
    name: 'Wegovy (semaglutide) Tablets PGD v006',
    description: 'Signed 8 Sep 2026. One stopping rule in place of two conflicting ones, baseline weight required at initiation and carried forward, documented evidence of the current injection dose required before switching with a stated pathway for doses below 2.4 mg, and the concurrent GLP-1 exclusion widened to any indication. The practitioner Agreement to practise page, the premises block and the signature table are restored, with the standard governance requirements. No clinical content changed.',
    category: 'PGD',
    file: 'PPH-Wegovy-Tablets-PGD-v006.pdf',
    fileSize: 205000,
    signedAt: '2026-09-09',
  },
  {
  ...
  {
    id: 'pph-covid-v005',
    name: 'COVID-19 PGD v005, 2026/27',
    description: 'Signed 8 Sep 2026. Comirnaty XFG is the vaccine of choice. Comirnaty LP.8.1 is authorised from existing stock only, until it is used up or reaches its expiry date. Spikevax LP.8.1 and Nuvaxovid JN.1 remain as alternatives, 12 years and over. The practitioner Agreement to practise page, the premises block and the signature table are restored, with the standard governance requirements. No clinical content changed.',
    category: 'PGD',
    file: 'PPH-COVID-PGD-v005-2026-27.pdf',
    fileSize: 188796,
    signedAt: '2026-09-09',
  },
  {
  ...
  {
    id: 'pph-menacwy-v003',
    name: 'Meningococcal ACWY PGD v003 (Nimenrix, MenQuadfi and Menveo)',
    description: 'Signed 7 Sep 2026. Full clinical review. Adds a 15 minute observation period for every patient, the Menveo CRM197 hypersensitivity exclusion, per-product age floors (Nimenrix 6 weeks, MenQuadfi 12 months, Menveo 2 years) and the Saudi certificate requirement that the vaccine be recorded as a conjugate. The practitioner Agreement to practise page, the premises block and the signature table are restored, with the standard governance requirements. No clinical content changed.',
    category: 'PGD',
    file: 'PPH-MenACWY-PGD-v003.pdf',
    fileSize: 149521,
    signedAt: '2026-09-09',
  },
  {
  ...
  {
    id: 'pph-rabies-v004',
    name: 'Rabies Pre-Exposure PGD v004',
    description: 'Signed 8 Sep 2026. Adds consent in children and young people: parental responsibility, or Gillick competence with the basis recorded. The conventional course has no lower age limit, so children are in scope and v002 said nothing about it. The practitioner Agreement to practise page, the premises block and the signature table are restored, with the standard governance requirements. No clinical content changed.',
    category: 'PGD',
    file: 'PPH-Rabies-PreExposure-PGD-v004.pdf',
    fileSize: 176000,
    signedAt: '2026-09-09',
  },
  {
