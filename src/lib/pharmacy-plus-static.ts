...
const STATIC_RESOURCES: StaticResourceInput[] = [
  ...
  {
    id: 'pph-wegovy-tablets-v005',
    name: 'Wegovy (semaglutide) Tablets PGD v005',
    description: 'Signed 8 Sep 2026. One stopping rule in place of two conflicting ones, baseline weight required at initiation and carried forward, documented evidence of the current injection dose required before switching with a stated pathway for doses below 2.4 mg, and the concurrent GLP-1 exclusion widened to any indication.',
    category: 'PGD',
    file: 'PPH-Wegovy-Tablets-PGD-v005.pdf',
    fileSize: 205000,
    signedAt: '2026-09-08',
  },
  {
  ...
  {
    id: 'pph-covid-v004',
    name: 'COVID-19 PGD v004, 2026/27',
    description: 'Signed 8 Sep 2026. Comirnaty XFG is the vaccine of choice. Comirnaty LP.8.1 is authorised from existing stock only, until it is used up or reaches its expiry date. Spikevax LP.8.1 and Nuvaxovid JN.1 remain as alternatives, 12 years and over.',
    category: 'PGD',
    file: 'PPH-COVID-PGD-v004-2026-27.pdf',
    fileSize: 188796,
    signedAt: '2026-09-08',
  },
  {
  ...
  {
    id: 'pph-rabies-v003',
    name: 'Rabies Pre-Exposure PGD v003',
    description: 'Signed 8 Sep 2026. Adds consent in children and young people: parental responsibility, or Gillick competence with the basis recorded. The conventional course has no lower age limit, so children are in scope and v002 said nothing about it.',
    category: 'PGD',
    file: 'PPH-Rabies-PreExposure-PGD-v003.pdf',
    fileSize: 176000,
    signedAt: '2026-09-08',
  },
  {
