...
const SPREAD_SIGNS=[
 ...
 {bullet:'Malaise, feeling generally unwell. RIGORS ARE NOT ON THIS LIST: a rigor is a sepsis red flag in Appendix 1 and refers.'},
 {bullet:'Cellulitis: diffuse redness and swelling spreading into the soft tissues of the face, without red flags. ANY SPREAD TO THE NECK is an Appendix 1 emergency, not a reason to supply.'},
];
...
const d={
 ...
 strap:'Patient Group Direction, version 006, issued 10 September 2026. Amoxicillin and metronidazole, adults 18 and over, spreading or systemic dental infection only.',
 ...
 guidelines:{
  ...
  sections:[
   ...
   {h:'When an antibiotic IS indicated',body:[
     ...
     {bullet:'Systemic: fever, malaise, rigors. SDCEP takes a temperature above 38C as indicating systemic involvement. In this PGD a rigor is treated as a sepsis red flag and refers (Appendix 1); it is not a reason to supply.'},
 ...
 appendix:[
  ...
  {bullet:'Diffuse redness and swelling spreading into the soft tissues of the face, not the neck.'},
  {bullet:'Malaise, feeling generally unwell.'},
  {bullet:'NOT rigors and NOT any spread to the neck: both are Appendix 1 emergencies and go to 999 or same-day care, never to a supply.',b:true},
 ...
 changes:[
  'RIGORS REMOVED FROM THE SIGNS THAT QUALIFY A PATIENT FOR A SUPPLY. Version 005 listed rigors as a sign of systemic involvement in the inclusion criteria of both arms and in Appendix 2, and also as a sepsis red flag in Appendix 1 that refers to 999 or same-day care. The same finding included and excluded the same patient, on the presentation where delay matters most. Rigors are now a red flag only.',
  'SPREAD TO THE NECK REMOVED FROM THE INCLUSION CRITERIA. Version 005 counted cellulitis spreading into the soft tissues of the face or neck as a reason to supply, while the cover and Appendix 1 treated swelling extending down the neck as an airway emergency. Neck involvement is now an emergency only. Both found by the clinical review of 10 September 2026.',
 ],
 prior:[
